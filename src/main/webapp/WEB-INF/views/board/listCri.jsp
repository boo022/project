			...
			<div class='box'>
				...
				<div class='box-body'>
					...
					<select name="searchType">
						<option value="n"
							<c:out value="${cri.searchType == null?'selected':''}"/>> <!-- 검색 조건이 없음 -->
							---</option>
						<option value="t"
							<c:out value="${cri.searchType eq 't'?'selected':''}"/>> <!-- 제목으로 검색 -->
							Title</option>
						<option value="c"
							<c:out value="${cri.searchType eq 'c'?'selected':''}"/>> <!-- 내용으로 검색 -->
							Content</option>
						<option value="w"
							<c:out value="${cri.searchType eq 'w'?'selected':''}"/>> <!-- 작성자로 검색 -->
							Writer</option>
						<option value="tc"
...
<%@include file="../include/footer_test.jsp"%>
